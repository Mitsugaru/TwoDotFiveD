...
public class GL_Matrix
{
	...
	/**
	 * creates rotation matrix for a thrid person camera
	 ...
	 */
	public static GL_Matrix rotate(float angle, GL_Vector axis, GL_Matrix src, GL_Matrix dest) {
        if (dest == null)
            dest = new GL_Matrix();
	...
	public static GL_Matrix rotateMat(float dx, float dy, float dz)
	{
		GL_Matrix out=new GL_Matrix();
		float SIN;
		float COS;
