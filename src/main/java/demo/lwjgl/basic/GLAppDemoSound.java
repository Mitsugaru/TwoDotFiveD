 ...
 */
public class GLAppDemoSound extends GLApp {
    ...
    public static void main(String args[]) {
        GLAppDemoSound demo = new GLAppDemoSound();
    ...
    public void setup()
    {
        ...
        sphereTextureHandle = makeTexture("src/main/resources/com/lovetextures/cubes.jpg");
        ...
        int frogSample = SoundScape.loadSoundData("com/flashkit/Are_you_-Darren_E-7464.wav");
        int cyberSample = SoundScape.loadSoundData("com/flashkit/Eerie_sp-Cosmic_D-191.wav");  //jet_cruising_loop_1.wav"); //
