...
public class CraftTask implements Comparable<Object>, BukkitTask {
    ...
    CraftTask(Runnable task, boolean syncTask) {
        this(task, syncTask, -1, -1);
    }

    CraftTask(Runnable task, boolean syncTask, long executionTick) {
        this(task, syncTask, executionTick, -1);
    }

    CraftTask(Runnable task, boolean syncTask, long executionTick, long period) {
        this.task = task;
