...
/**
 * Takes a custom .bsp file. First line of a batch is the number of verticies.
 * Then, for that number of lines, enter floats of each vertex of the object.
 * Follows x,y,z coordinate system, and floats are space delimited. Goes until
 * end of file.
 * 
 * @author jezek2
 */
