...
public abstract class DemoApplication {
    ...
    protected final Vector3f cameraTargetPosition = new Vector3f(0f, 0f, 0f); // look
									      // at
	...
	case '9': {
	     ...
	     * if(rb.isActive()) { //TODO Figure out how to remove last object
	     * without crashing //TODO Figure out why it doesn't remove all
	     * objects at once //dynamicsWorld.removeRigidBody(rb); } } }
	     */
