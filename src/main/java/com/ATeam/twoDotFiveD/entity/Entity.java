...
public class Entity extends RigidBody implements Serializable {
	...
	private Vector3f image;

	public Entity(float mass, MotionState state, CollisionShape shape,
			Vector3f localInertia, String ID, Vector3f image,
			String[] description) {
	...
	public Entity(RigidBodyConstructionInfo info, String ID, Vector3f image,
			String[] description) {
		super(info);
		this.ID = ID;
		this.image = image;
